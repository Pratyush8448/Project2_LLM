...
# Optional: A function to call `fetch` synchronously
def fetch_data():
...
async def get_weather_forecast(city: str) -> str:
    ...
    try:
        ...
        params = {
            ...
            "order": "importance",
            "q": city.strip(),  # ✅ FIX: Correct query parameter & strip spaces
            "format": "json",
        }
        ...
        async with httpx.AsyncClient() as client:
            ...
            # ✅ Format weather data
            weather_forecast = {f["localDate"]: f["enhancedWeatherDescription"] for f in forecasts if "localDate" in f and "enhancedWeatherDescription" in f}
...
async def extract_tables_from_pdf(file_path: str) -> str:
    ...
    who scored 17 or more marks in Physics.
    ...
    try:
        ...
        required_columns = ["Physics", "Biology"]
        ...
        # Filter students with Physics marks ≥ 17
        filtered_df = combined_df[combined_df["Physics"] >= 17]
